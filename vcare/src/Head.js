...
function Head(){
    ...
    <div className="Head">
              <Component 
               ...
               info="The goal of skull fracture treatment is to control pain, promote healing, and prevent complications. For most skull fractures, which are linear fractures, surgical intervention is not needed. Instead, physicians prescribe medication to control pain and maintain close observation in the hospital."
               image="https://ssl.adam.com/graphics/images/en/9054.jpg"
               info1="diagnosis relies on physical examination and imaging studies of the head. During the examination, the physician obtains a complete medical history of the patient and asks how the injury occurred.
